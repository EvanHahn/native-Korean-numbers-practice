describe('getKorean', function() {
	...
	it('converts 11 through 19', function() {
		expect(getKorean(11)).toEqual('열 하나');
		expect(getKorean(12)).toEqual('열 둘');
		expect(getKorean(13)).toEqual('열 셋');
		expect(getKorean(14)).toEqual('열 넷');
		expect(getKorean(15)).toEqual('열 다섯');
		expect(getKorean(16)).toEqual('열 여섯');
		expect(getKorean(17)).toEqual('열 일곱');
		expect(getKorean(18)).toEqual('열 여덟');
		expect(getKorean(19)).toEqual('열 아홉');
	});
	...
	it('converts 21', function() {
		expect(getKorean(21)).toEqual('스물 하나');
	});

	it('converts 69', function() {
		expect(getKorean(69)).toEqual('예순 아홉');
	});
